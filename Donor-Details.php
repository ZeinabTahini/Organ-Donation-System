...
?>
    ...
    <head>
        ...
        <!-- <meta name="viewport" content="width=device-width, user-scalable ="no"> -->
         <title> Organ Donor | Admin-Donor-Details</title>
	  <!-- Favicon -->
        ...
        <div class="container">
            <div class="sidebar">
                ...
                <div class="menu-bar">
                    <div class="menu">
                        <li class="menu-link">
                            <a href="Donor-Details.php" class="active">
                        ...
                        <table>
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th> Donor Name <span class="icon-arrow">&UpArrow;</span></th>
                                    ...
                                    <th> Donate Organ <span class="icon-arrow">&UpArrow;</span></th>
                                    <th> Causes of Death <span class="icon-arrow">&UpArrow;</span></th>
...
?>
    <tr>
        ...
        <td><?php echo $row['hospital_username']; ?></td> <!-- Display hospital username -->
