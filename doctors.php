...
?>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
    ...
    ?>
				...
				<a href="doctors.php" class="menu-item is-active"><i class="fa-solid fa-user-doctor"></i> All Saved Doctors </a>
  ...
  <i class="bx bx-log-out icons"></i> Logout
    ...
    <table class="table table-hover responsiveTable" id="example1">
      ...
      <tbody>
                            <?php 
                            $result = mysqli_query($con,"SELECT * FROM doctor where status = '1'");
                            ...
                            ?>
                                <tr>
									...
									<td><a href="delete-doctor.php?id=<?php echo $row['id'];?>" style="color: #07960c; text-decoration: none;"><i class="fa-regular fa-trash-can"></i></a></td>
                                    </tr>
                                    <?php
                                }
                            } else {
...
<script type="text/javascript">
    ...
    (() => {
        ...
        // basic table
        let headers1 = ['Id', 'Docotr Name', 'CV', 'E-Mail', 'Delete'];
