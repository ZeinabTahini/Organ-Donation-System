    ...
    <html lang="en">
     ...
     <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
         <title> Organ Donor | Hospital-Saved-Appointment </title>
	  <!-- Favicon -->
    ...
    <body>
		...
		<aside class="sidebar">
			...
			<nav class="menu">
				...
				<a href="saved-appointment.php" class="menu-item is-active"><i class="fa-regular fa-calendar-check"></i> Saved Appointment </a>
...
$result = mysqli_query($con, "SELECT appointment.*, donor_details.donor_name AS donor_name, donor_details.email AS donor_email, patient_details.patient_name AS patient_name, patient_details.email AS patient_email, doctor.username AS doctor_name
                              ...
                              WHERE appointment.status='1' AND appointment.hid = $hid");
